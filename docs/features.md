...
* **Video Platforms** - YouTube, Netflix, Prime Video, Disney+, Hulu, Crunchyroll
...
* Works with the VeTerex Chrome Extension
...
* **Burnable** - You can remove achievements if desired
...
* **Group Chat** - Join groups based on shared achievements
