...
const mediaTypes = [
  { type: 'book', icon: Book, label: 'Books', color: 'from-emerald-500 to-green-600' },
  { type: 'movie', icon: Film, label: 'Movies', color: 'from-red-500 to-rose-600' },
  { type: 'anime', icon: Play, label: 'Anime', color: 'from-pink-500 to-fuchsia-600' },
  { type: 'manga', icon: BookOpen, label: 'Manga', color: 'from-orange-500 to-amber-600' },
  { type: 'tvshow', icon: Tv, label: 'TV Shows', color: 'from-blue-500 to-indigo-600' },
]
    ...
    <div className="px-4 py-6 space-y-8">
      ...
      >
        <motion.div
          ...
          className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-accent-500 to-primary-500 
                     flex items-center justify-center shadow-xl shadow-accent-500/30"
        >
        ...
        >
          Earn verified NFT badges for every book, movie, anime, and show you complete. 
          Connect with others who share your achievements.
        </motion.p>
        ...
        >
          ...
          <div className="card">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent-500/20 to-primary-500/20 
        ...
        <Link to="/explore">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-dark-400">Mark a book, movie, or show as completed</p>
            </div>
        ...
        <Link to="/community">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-dark-400">Connect with others who share your interests</p>
            </div>
            <ArrowRight className="w-5 h-5 text-dark-500" />
          </motion.div>
        </Link>
