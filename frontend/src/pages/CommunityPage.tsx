...
const mockGroups: Group[] = [
  {
    ...
    media: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=300&h=400&fit=crop',
      releaseYear: 1994,
  ...
  },
  {
    ...
    media: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=300&h=400&fit=crop',
      releaseYear: 2006,
      creator: 'Madhouse',
      genre: ['Thriller'],
  ...
  },
  {
    ...
    media: {
      ...
      coverImage: 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=300&h=400&fit=crop',
      releaseYear: 2008,
      ...
      <div className="px-4 py-6 flex flex-col items-center justify-center min-h-[60vh]">
        ...
        >
          ...
          <p className="text-dark-400 max-w-xs mx-auto mb-6">
            Connect your wallet to discover others who share your media achievements
          </p>
        </motion.div>
      </div>
    )
    ...
    <div className="px-4 py-6 space-y-6">
      ...
      {activeTab === 'groups' ? (
          ...
          {mockGroups.map((group, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-white truncate">{group.media.title}</h3>
                <p className="text-sm text-dark-400 capitalize">{group.media.type}</p>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-dark-400">
                  Users with matching achievement NFTs are automatically visible to each other. 
                  Connect with people who share your media journey!
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Matching Users */}
          <div>
            <h2 className="text-lg font-semibold text-white mb-4">People Like You</h2>
